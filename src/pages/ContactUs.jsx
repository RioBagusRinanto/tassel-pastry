    ...
    <section className="w-full py-16 px-4 bg-white flex items-center justify-center min-h-[60vh]">
      <div className="max-w-3xl w-full bg-orange-50 rounded-3xl shadow-xl p-8">
        ...
        <div className="mb-8 text-center">
          <p className="text-lg text-gray-700 mb-2 font-medium">We'd love to hear from you! Reach out to us using the details below.</p>
          <div className="flex flex-col items-center gap-2 mb-4">
            <span className="text-base text-gray-700"><strong>Phone:</strong> +1 (212) 555-1234</span>
            <span className="text-base text-gray-700"><strong>Email:</strong> hello@tasselpastry.com</span>
            <span className="text-base text-gray-700"><strong>Address:</strong> 123 Broadway, New York, NY 10001, USA</span>
          </div>
        </div>
